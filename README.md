...
FOTOS DAS PRAIAS
As 27 imagens fornecidas pelo usuário foram incorporadas em public/uploads/praias e vinculadas aos 27 cadastros de praias em data/db.json.


V7.1: imagens reais dos pontos turísticos fornecidas pelo usuário foram incluídas em public/uploads/pontos e vinculadas aos cadastros correspondentes.

ATUALIZAÇÃO V7.2
- Página inicial usa a foto enviada "Eu Amo Guarujá" como fundo.
- Logo da Prefeitura + Secretaria de Turismo adicionada ao hero e rodapé.
- As imagens de marca e a foto principal ficam em /uploads para serem servidas corretamente pelo Node.js.
- Instagram da Secretaria de Turismo: https://www.instagram.com/turismoguaruja/
- Página pública mantém uma seleção de hotéis e restaurantes; o painel administrativo continua sendo a área para gerenciar os cadastros.


## V7.3
- Navegação mobile com menu recolhível.
- Layout responsivo reforçado para celulares e tablets.
- Nova área de Contato para Setur e Prefeitura.
- Links oficiais de Instagram, site, telefone e e-mail.
