...
const schema={
 praias:[
  ...
  ["permitido","O que pode fazer","tags"],["proibido","O que não pode fazer","tags"],["observacoes","Observações importantes","textarea"],["destaque","Destacar na página inicial?","checkbox"]
 ],
 restaurantes:[
  ...
  ["servicos","Serviços/recursos","tags"],["acessibilidade","Acessibilidade","textarea"],["delivery","Delivery","text"],["reservas","Reservas","text"],["observacoes","Observações","textarea"],["destaque","Destacar na página inicial?","checkbox"]
 ],
 hoteis:[
  ...
  ["cafe_manha","Café da manhã","text"],["piscina","Piscina","text"],["observacoes","Observações","textarea"],["destaque","Destacar na página inicial?","checkbox"]
 ],
 pontos:[
  ...
  ["acessibilidade","Acessibilidade","textarea"],["entrada","Entrada/ingresso","text"],["observacoes","Observações","textarea"],["destaque","Destacar na página inicial?","checkbox"]
 ],
 noticias:[
